...
<form  method="post" action="${SITE_URL}/students/save">
    <div class="form-group">
        ...
        <input type="text" name="firstName" required="required" class="form-control" value="${student.firstName}"/>
    </div>
    <div class="form-group">
        <label>Last name</label>
        <input type="text" name="lastName" required="required" class="form-control" value="${student.lastName}"/>
    </div>
    <div class="form-group">
        <label>Email</label>
        <input type="email" name="email" required="required" class="form-control" value="${student.email}"/>
    </div>
    <div class="form-group">
